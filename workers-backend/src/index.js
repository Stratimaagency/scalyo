...
// Routes that need auth applied from parent (Hono sub-router middleware bug)
app.use('/api/roadmap/*', ...mw)
app.use('/api/coach/*', ...mw)
app.use('/api/email-studio/*', ...mw)
app.use('/api/feedback/*', ...mw)
