...
export const useTaskStore = defineStore('tasks', () => {
  ...
  const tasks = ref([
    { id: 't1', title: 'QBR Acme Corp', status: 'todo', priority: 'urgent_important', projectId: 'p3', clientId: 'cl2', assignee: 'tm1', dueDate: '2026-04-15', description: 'Préparer le QBR trimestriel pour Acme Corp', subtasks: [{ id: 'st1', title: 'Collecter les KPIs', done: true }, { id: 'st2', title: 'Préparer slides', done: false }], createdAt: '2026-04-01' },
