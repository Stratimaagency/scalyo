...
export const useTaskStore = defineStore('tasks', () => {
  ...
  const tasks = ref([
    { id: 't1', title: 'QBR Acme Corp', status: 'todo', priority: 'urgent_important', projectId: 'p3', clientId: 'cl2', assignee: 'u1', dueDate: '2026-04-15', description: 'Préparer le QBR trimestriel pour Acme Corp', subtasks: [{ id: 'st1', title: 'Collecter les KPIs', done: true, children: [{ id: 'st1a', title: 'KPIs usage produit', done: true, children: [] }, { id: 'st1b', title: 'KPIs satisfaction', done: false, children: [{ id: 'st1b1', title: 'Score NPS', done: false, children: [] }, { id: 'st1b2', title: 'Score CSAT', done: false, children: [] }] }] }, { id: 'st2', title: 'Préparer slides', done: false, children: [{ id: 'st2a', title: 'Template PowerPoint', done: false, children: [] }, { id: 'st2b', title: 'Graphiques résultats', done: false, children: [] }] }], createdAt: '2026-04-01' },
    { id: 't2', title: 'Check-in TechScale', status: 'in_progress', priority: 'important', projectId: 'p1', clientId: 'cl1', assignee: 'u1', dueDate: '2026-04-18', description: 'Call mensuel de suivi', subtasks: [], createdAt: '2026-04-05' },
    ...
    { id: 't7', title: 'Rapport COPIL Mars', status: 'done', priority: 'not_urgent', projectId: null, clientId: null, assignee: 'u1', dueDate: '2026-04-05', description: 'Générer le rapport mensuel', subtasks: [], createdAt: '2026-03-30', completedAt: '2026-04-05' },
