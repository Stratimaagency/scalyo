...
.slide-over-panel { position: fixed; top: 0; right: 0; z-index: 10000; max-width: 100vw; height: 100vh; background: var(--bg-card); box-shadow: -4px 0 24px rgba(0,0,0,0.15); display: flex; flex-direction: column; overflow: hidden; }
