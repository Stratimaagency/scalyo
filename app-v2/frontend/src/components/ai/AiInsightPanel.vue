...
.aip-title { flex: 1; font-size: 0.88rem; font-weight: 700; color: #4c1d95; }
.ai-insight-panel.locked .aip-title { color: #6b7280; }
.aip-btn { background: #7c3aed; color: #fff; border: none; padding: 6px 16px; border-radius: 8px; font-size: 0.78rem; font-weight: 600; cursor: pointer; transition: all 0.15s; }
...
.aip-upgrade { margin-top: 8px; font-size: 0.78rem; color: #6b7280; font-style: italic; }
.aip-loading { display: flex; align-items: center; gap: 10px; margin-top: 12px; padding: 12px; }
.aip-thinking { display: flex; gap: 4px; }
.aip-thinking span { width: 6px; height: 6px; background: #7c3aed; border-radius: 50%; animation: aip-bounce 1.4s infinite; }
