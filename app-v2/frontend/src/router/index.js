...
const routes = [
  ...
  { path: '/register', name: 'register', component: () => import('@/views/RegisterView.vue'), meta: { guest: true } },
  {
    ...
    children: [
      ...
      { path: 'kpis/new', name: 'kpis-new', component: () => import('@/views/kpis/KpisNew.vue') },
      { path: 'kpis/:id', name: 'kpis-dashboard', component: () => import('@/views/kpis/KpisDashboard.vue'), props: true },
