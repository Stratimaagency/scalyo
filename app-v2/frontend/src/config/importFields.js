...
export var clientFields = [
  ...
  { key: 'health', label: 'imp_field_health', type: 'number', aliases: ['sante', 'health score', 'score sante'] },
  { key: 'nps', label: 'imp_field_nps', type: 'number', aliases: ['net promoter', 'score nps'] },
...
export var taskFields = [
  ...
  { key: 'urgency', label: 'imp_field_urgency', type: 'number', aliases: ['urgence'] },
  { key: 'importance', label: 'imp_field_importance', type: 'number', aliases: [] },
  { key: 'difficulty', label: 'imp_field_difficulty', type: 'number', aliases: ['difficulte', 'complexite', 'complexity'] },
...
export var teamFields = [
  ...
  { key: 'wellbeingScore', label: 'imp_field_wellbeing', type: 'number', aliases: ['bien-etre', 'wellbeing', 'bienetre', 'score bienetre'] },
  { key: 'workload', label: 'imp_field_workload', type: 'number', aliases: ['charge', 'charge travail', 'occupation'] },
  { key: 'clientCount', label: 'imp_field_client_count', type: 'number', aliases: ['nombre clients', 'client count', 'nb clients', 'portefeuille'] },
