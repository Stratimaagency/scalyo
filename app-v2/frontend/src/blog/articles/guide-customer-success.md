---
title: "Le Guide Complet du Customer Success en 2026"
slug: guide-customer-success
description: "Tout ce qu'un Head of CS doit savoir pour structurer, mesurer et scaler une équipe Customer Success en SaaS B2B. Health score, NRR, churn, playbooks, outils."
date: "2026-05-11"
updated: "2026-05-11"
...
Trop d'équipes CS mesurent tout et n'agissent sur rien. Voici les indicateurs qui méritent un dashboard permanent.

### Net Revenue Retention (NRR)

Le NRR mesure combien de revenu vous conservez de vos clients existants, expansion incluse. Un NRR supérieur à 100% signifie que votre base installée croît même sans nouveaux clients. Les SaaS B2B performants visent un NRR entre 110% et 130%.

La formule : (MRR début de période + expansion - contraction - churn) / MRR début de période × 100

### Health Score

Le health score agrège plusieurs signaux pour donner une note de santé à chaque compte. Les signaux les plus prédictifs sont l'engagement produit (fréquence de connexion, adoption des fonctionnalités clés), le NPS ou CSAT, la ponctualité des paiements, et le niveau d'engagement des stakeholders.
...
En règle générale : pour du high-touch (ACV supérieur à 50K€), un CSM gère 15-30 comptes. Pour du mid-touch (ACV entre 10K€ et 50K€), un CSM gère 30-80 comptes. Pour du tech-touch (ACV inférieur à 10K€), l'automatisation prend le relais avec un ratio de 1 CSM pour 200+ comptes.
...
Un playbook est un protocole standardisé qui définit les actions à prendre quand un trigger se déclenche. Quatre playbooks couvrent 80% des situations.
...
L'erreur classique est d'empiler trop d'outils. Choisissez une plateforme CS qui centralise le maximum de fonctions : portefeuille clients, health score, tâches, playbooks, email et reporting.
